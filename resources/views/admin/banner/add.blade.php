...
<div style="margin-bottom:10px;border-bottom:1px solid #eee;padding: 0 0 6px;"><a  href="{:url('advert/index')}"  >管理广告</a><span style="margin-left: 10px;margin-right: 10px;">|</span> <a  href="{:url('advert/add')}" class="btn btn-info"  style="height:22px;line-height:14px;" >添加广告</a> <span style="margin-left: 10px;margin-right: 10px;">
</div>
...
<div class="col-sm-12">
  <div class="tabs-container">
    <ul class="nav nav-tabs">
      <li class="active">
        <a data-toggle="tab" href="#tab-1" aria-expanded="true">添加广告</a>
      </li>
      ...
      <div id="tab-1"  class="tab-pane active ">
        <div class="panel-body">
          <div class="ibox-content">
            <form method="post" class="form-horizontal" action="{:url('advert/insert')}" enctype="multipart/form-data" onSubmit="return check();">                     
