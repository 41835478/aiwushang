...
<div class="content">
	...
	<ul class="bank_main">
		...
		<li>
			...
			<input type="text" placeholder="请输入短信验证码"  name="code" class="code" onfocus="this.placeholder = ''" onblur="if(this.placeholder == ''){this.placeholder = '请输入短信验证码'}" class="alipay_ipt">
